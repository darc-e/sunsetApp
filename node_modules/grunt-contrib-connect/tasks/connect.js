  ...
  grunt.registerMultiTask('connect', 'Start a connect web server.', function() {
    ...
    server
      ...
      .on('listening', function() {
        ...
        grunt.log.writeln('Started connect web server on ' + (address.address || '127.0.0.1') + ':' + address.port + '.');
        grunt.config.set('connect.' + taskTarget + '.options.hostname', address.address || '127.0.0.1');
        grunt.config.set('connect.' + taskTarget + '.options.port', address.port);

        grunt.event.emit('connect.' + taskTarget + '.listening', (address.address || '127.0.0.1'), address.port);
