...
var tests = [
  ...
  function(next) {
    request({
      'method': 'GET',
      'uri': 'http://test:testing2@127.0.0.1:6767/test2/'
    }, function(error, res, body) {
      assert.equal(res.statusCode, 200);
  ...
  function(next) {
    assert.doesNotThrow( function() {
      request({
        'method': 'GET',
        'uri': 'http://127.0.0.1:6767/allow_empty_user/',
        'auth': {
          'user': '',
          'pass': 'apassword',
          'sendImmediately': false
  ...
  function(next) {
    assert.doesNotThrow( function() {
      request({
        'method': 'GET',
        'uri': 'http://127.0.0.1:6767/allow_undefined_password/',
        'auth': {
          'user': 'justauser',
          'pass': undefined,
          'sendImmediately': false
